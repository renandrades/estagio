...
file_rf = open("Tuning_rf_sens.csv","w")
...
file_svm = open("Tuning_svm_sens.csv","w")
...
dump(best_svm, 'best_svm_sens.pkl')            
...
file_gbc = open("Tuning_gbc_sens.csv","w")
...
dump(best_gbc, 'best_gbc_sens.pkl')                
